...
<form method="post" name="addToCartPWYW" id="addToCartPWYW">
  ...
  <input type="number" name="productPricePWYW" id="productPricePWYW" onkeypress="return isNumberPWYW(event)" placeholder="Enter Price you want" value="{{ product.price | money_without_currency | remove: \'.00\' | remove: \',00\' }}">
